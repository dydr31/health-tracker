...
export const TimeOfDayButtons: React.FC = () => {
  ...
  return (
    <div className={classes["display-buttons"]}>
      <SmallButton text="morning" active={isMorning} onClick={toggleButtons} rounded={true}/>
      <SmallButton text="evening" active={!isMorning} onClick={toggleButtons} rounded={true}/>
    </div>
  );
};
